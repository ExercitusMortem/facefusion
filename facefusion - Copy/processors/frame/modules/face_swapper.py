...
def register_args(program : ArgumentParser) -> None:
	...
	program.add_argument('--face-swapper-weight', help = wording.get('face_swapper_weight'), type = float, default = config.get_float_value('frame_processors.face_swapper_weight', '1.0'), choices = frame_processors_choices.face_swapper_weight_range, metavar = create_metavar(frame_processors_choices.face_swapper_weight_range))
